...
class ProfileTest(TestCase):
    def setUp(self):
        ...
        self.profile = Profile.objects.create(user = self.user,bio = 'bio', contact='mycontact@gmail.com')
...
class PostTest(TestCase):
    def setUp(self):
        self.user = User.objects.create(id = 1, username='test')
        self.profile = Profile.objects.create(user = self.user,bio = 'my bio',contact='mycontact')
